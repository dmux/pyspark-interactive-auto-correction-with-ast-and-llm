...
try:
    ...
    df_input_generation.write.mode('overwrite').parquet('/var/folders/z4/zjs9h8rx6gj_2xc97nfw1f240000gn/T/temp_pyspark_st_run_f4bdd767_3efa3a4e/dados_entrada_raw.parquet')
    ...
    df_raw = spark.read.parquet('/var/folders/z4/zjs9h8rx6gj_2xc97nfw1f240000gn/T/temp_pyspark_st_run_f4bdd767_3efa3a4e/dados_entrada_raw.parquet')
    ...
    df_filtered.write.mode('overwrite').parquet('/var/folders/z4/zjs9h8rx6gj_2xc97nfw1f240000gn/T/temp_pyspark_st_run_f4bdd767_3efa3a4e/intermediate_data/transactions_filtered.parquet')
    ...
    df_intermediate_read = spark.read.parquet('/var/folders/z4/zjs9h8rx6gj_2xc97nfw1f240000gn/T/temp_pyspark_st_run_f4bdd767_3efa3a4e/intermediate_data/transactions_filtered.parquet')
    ...
    df_final.write.mode('overwrite').parquet('/var/folders/z4/zjs9h8rx6gj_2xc97nfw1f240000gn/T/temp_pyspark_st_run_f4bdd767_3efa3a4e/output_data/final_report.parquet')
